...
<head>
    <title>Rosario Costantini - Nosotros</title>
  ...
  <body>
    <div class="wrap-for-sticky js-wrap-for-sticky">
      ...
      <!-- HEADER END-->
      <!-- CONTENT-->
      <main class="main pt100">

        <section class="section single">
          <div class="container">
            <article class="article-single -blog">
              <div class="article-blog_header" style="padding-bottom: 30%">
                <div class="-resp-bg-img" style="background-image: url(img/us.jpg);"></div>
                <div class="article-blog_content">
                  <h1 class="h2 article-blog_title"></h1>
                  <div class="article-blog_content_info">
                ...
                <div class="descr-block">
                  <div class="row">
                    <div class="col-md-8 offset-md-2">
                      <h3>Quiénes Somos</h3>
                      <p>Somos una <em>inmobiliaria boutique</em> atendida directamente por sus dueños ofreciendo un servicio cien por ciento personalizado y nos diferenciamos por la excelencia y la relación directa con cada uno de nuestros clientes.</p>

                      <p>Los valores que destacamos, y con los que trabajamos día a día son <em>el servicio personalizado, la atención de excelencia y transparencia;</em> generando una relación de confianza y de largo plazo con nuestros clientes. Gestionamos negocios inmobiliarios defendiendo los intereses de todas las partes involucradas. Comercializamos terrenos, casas, oficinas y locales comerciales de calidad y excelente ubicación.</p>

                      <p><em>Rosario Costantini</em> comenzó a comercializar <em>Nordelta</em> desde sus inicios y hoy es una inmobiliaria consolidada de la zona norte de Buenos Aires.</p>
                    </div>
