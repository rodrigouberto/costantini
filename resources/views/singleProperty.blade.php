...
<head>
    ...
    <link rel="mask-icon" href="{{asset('img/safari-pinned-tab.svg')}}" color="#65b5e3">
                ...
                <nav class="navbar navbar-expand-lg"><a href="index.html" class="logo"><img class="header-logo" src="img/logo3.png" alt=""></a>
                  ...
                  <div class="collapse navbar-collapse" id="header_navbar">
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item"><a class="nav-link" href="nordelta">Nordelta</a></li>
                      <li class="nav-item"><a class="nav-link" href="puertos">Puertos</a></li>
                      <li class="nav-item"><a class="nav-link" href="about">Nosotros</a></li>
                      <li class="nav-item"><a class="nav-link" href="tasaciones">Tasaciones</a></li>
                    </ul>
                  </div>
                </nav>
                ...
                <article class="article-single -flat pb-0">
                  <div class="article-top">
                    <div class="article-top_header">
                      <h1 class="h5 article-top_header_title">Casa en Los Castores</h1>
                      <div class="article-top_header_price">US$1.200.000</div>
                    </div>
                      ...
                      <div class="article-top_slider_for js-single-slider-for -style_2">
                        <div class="item">
                          <div class="item-inner">
                            <div class="tag-list">
                              <div class="tag -sale">venta</div>

                            </div><a class="-resp-bg-img" href="{{asset('img/flat/full/flat-1.png')}}" style="background-image: url({{asset('img/flat/full/flat-1.png')}});"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="item-inner">
                            ...
                            </div><a class="-resp-bg-img" href="{{asset('img/flat/full/flat-2.png')}}" style="background-image: url({{asset('img/flat/full/flat-2.png')}});"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="item-inner"><a class="-resp-bg-img" href="{{asset('img/flat/full/flat-3.png')}}" style="background-image: url({{asset('img/flat/full/flat-3.png')}});"></a></div>
                        </div>
                  ...
                  <div class="article-info article-row">
                    ...
                    <div class="article-info_container">
                      <div class="article-info_item">
                        ...
                        <div class="title">Habitaciones: 2</div>
                      </div>
                      <div class="article-info_item">
                        <div class="icon"> <i class="icon-shower"></i></div>
                        <div class="title">Baños: 3</div>
                      </div>
                      <div class="article-info_item">
                        <div class="icon"> <i class="icon-house"></i></div>
                        <div class="title">Garage: 1</div>
                      </div>
                      <div class="article-info_item">
                        <div class="icon"> <i class="icon-select"></i></div>
                        <div class="title"> Terreno: 300&#13217;</div>
                      </div>
                    </div>
                  </div>
                  <div class="article-descr article-row">
                    ...
                    <div class="descr-block">
                     <p>Espectacular departamento de 3 dormitorios en el Complejo YOO, uno de los complejos de departamentos más premium de Nordelta.</p>

                      <p>Placard de recepción. Gran living comedor con salida al balcón terraza y espectacular vista al lago central de Nordelta. Toilette. Balcon terraza grande con parrilla. Espacio para mesa de 10 comensales, y juego de living exterior. Cocina amplia con espacio para lavavajilla, lavarropa y secarropas. La cocina tiene salida a un segundo balcón. Entrada de servicio.</p>


                      <p>Pasillos amplios con biblioteca. 3 dormitorios: Gran suite principal con salida al balcon terraza y vista al lago. Vestidor grande y baño en suite. Otros dos dormitorios muy luminosos y cómodos, con balcón al frente del edificio. Otro baño completo, grande, muy comodo.</p>


                      <p>Pisos de madera en living comedor y cocina. Dormitorios con alfombra parquet blanca, muy linda.</p>


                      <p>Todo el departamento es de excelente calidad, revestimientos y amoblamientos de primer nivel.</p>


                      <p>Edificio con pileta, gimnasio, sauna, cocheras. Edificio moderno de máxima categoría con detalles y terminaciones de diseño, del renombrado arquitecto Phillipe Starck sobre un proyecto de Carlos Ott; con los mayores estándares de comfort y amenities.</p>
                  ...
                  <div class="article-plans article-row">
                    ...
                    <div class="article-plans_container js-plans-lightbox">
                      <div class="article-plans_col">
                        <div class="article-plans_item"><a class="img -resp-bg-img" href="img/plans/plans_1.png" style="background-image: url({{asset('img/plans/plans_1.png')}});"></a>
                          <div class="overlay-resize"><i class="icon-expand"></i></div>
                        </div>
                      </div>
                      <div class="article-plans_col">
                        <div class="article-plans_item"><a class="img -resp-bg-img" href="img/plans/plans_2.png" style="background-image: url({{asset('img/plans/plans_2.png')}});"></a>
                          <div class="overlay-resize"><i class="icon-expand"></i></div>
                        </div>
                      </div>
                      <div class="article-plans_col">
                        <div class="article-plans_item"><a class="img -resp-bg-img" href="img/plans/plans_3.png" style="background-image: url({{asset('img/plans/plans_3.png')}});"></a>
                          <div class="overlay-resize"><i class="icon-expand"></i></div>
                        </div>
                      </div>
                    </div>
